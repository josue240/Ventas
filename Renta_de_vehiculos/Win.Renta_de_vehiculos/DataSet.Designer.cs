...
namespace Win.Renta_de_vehiculos {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class VehiculoDataTable : global::System.Data.TypedTableBase<VehiculoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public VehiculoRow AddVehiculoRow(string Descripcion, string Placa, int Existencia, bool Activo, int Tipoid, byte[] Foto, double Precio) {
            ...
            public string Placa {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Placa\' in table \'Vehiculo\' is DBNull.", e);
                    }
                }
                set {
            ...
            public byte[] Foto {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Foto\' in table \'Vehiculo\' is DBNull.", e);
                    }
                }
                set {
...
namespace Win.Renta_de_vehiculos.DataSetTableAdapters {
    ...
    public partial class VehiculoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Vehiculo] WHERE (([Id] = @Original_Id) AND ([Existencia] = @Or" +
                "iginal_Existencia) AND ([Activo] = @Original_Activo) AND ([Tipoid] = @Original_T" +
                "ipoid) AND ([Precio] = @Original_Precio))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Vehiculo] ([Descripcion], [Placa], [Existencia], [Activo], [Tipoid], [Foto], [Precio]) VALUES (@Descripcion, @Placa, @Existencia, @Activo, @Tipoid, @Foto, @Precio);
SELECT Id, Descripcion, Placa, Existencia, Activo, Tipoid, Foto, Precio FROM Vehiculo WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Vehiculo] SET [Descripcion] = @Descripcion, [Placa] = @Placa, [Existencia] = @Existencia, [Activo] = @Activo, [Tipoid] = @Tipoid, [Foto] = @Foto, [Precio] = @Precio WHERE (([Id] = @Original_Id) AND ([Existencia] = @Original_Existencia) AND ([Activo] = @Original_Activo) AND ([Tipoid] = @Original_Tipoid) AND ([Precio] = @Original_Precio));
SELECT Id, Descripcion, Placa, Existencia, Activo, Tipoid, Foto, Precio FROM Vehiculo WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Win.Renta_de_vehiculos.Properties.Settings.Default.RENTAVEHICULO_423c6178520248f891adf117728af1c0ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Descripcion, Placa, Existencia, Activo, Tipoid, Foto, Precio FROM dbo." +
                "Vehiculo";
        ...
        public virtual int Delete(int Original_Id, int Original_Existencia, bool Original_Activo, int Original_Tipoid, double Original_Precio) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_Existencia));
        ...
        public virtual int Insert(string Descripcion, string Placa, int Existencia, bool Activo, int Tipoid, byte[] Foto, double Precio) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, string Placa, int Existencia, bool Activo, int Tipoid, byte[] Foto, double Precio, int Original_Id, int Original_Existencia, bool Original_Activo, int Original_Tipoid, double Original_Precio, int Id) {
            if ((Descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, string Placa, int Existencia, bool Activo, int Tipoid, byte[] Foto, double Precio, int Original_Id, int Original_Existencia, bool Original_Activo, int Original_Tipoid, double Original_Precio) {
            return this.Update(Descripcion, Placa, Existencia, Activo, Tipoid, Foto, Precio, Original_Id, Original_Existencia, Original_Activo, Original_Tipoid, Original_Precio, Original_Id);
        }
    }
